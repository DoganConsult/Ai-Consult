import { getAssetByKey, getAssetById, type AIAsset } from '../../../ai-governance/services/ai/ai-asset-inventory.service';
import {
...
import { getEnabledToolAssetIdsForAgent } from '../../../ai-governance/services/ai/ai-binding-governance.service';
...
} from '../../../ai-governance/services/ai/ai-governance-config.service';
...
export interface AgentGovernanceResolution {
  ...
  resolved_agent_config: Record<string, any> | null;
