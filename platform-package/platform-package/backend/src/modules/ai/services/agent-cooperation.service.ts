...
export {
  ...
  getCycleContext,
  registerDiscovery,
} from './agent-cooperation/cycle-context';

// Execution planning and persistence
export {
  computeExecutionWaves,
  persistCycleSummary,
} from './agent-cooperation/execution-planner';

// Cross-agent correlation
export {
  correlateDiscoveries,
  runFullCorrelation,
} from './agent-cooperation/correlation';
...
} from './agent-cooperation/conflict-detection';
...
export {
  ...
  getPendingHandoffs,
  completeHandoff,
} from './agent-cooperation/handoff';

// Dependency graph
export {
  AGENT_DEPENDENCY_GRAPH,
  getAgentDependencyConfig,
} from './agent-cooperation/dependency-graph';
