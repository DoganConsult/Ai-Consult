...
import { getControlEvidenceQualityAverage } from "../../../evidence/services/analysis/evidence-quality-scoring.service";
...
export async function computeComplianceHeatMap(
  ...
  const __includeInactive = options?.includeInactive || false;
