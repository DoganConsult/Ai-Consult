...
function emit(tenantId: string, entityType: string, event: string, result?: Record<string, unknown> | null) {
  if (result) {
    emitEvent({ tenantId, userId: 'system', module: MODULE, event, entityType, entityId: result.id as string, data: result });
  }
}

// ── notifications ───────────────────────────────────────────────────────

export async function listNotifications(tenantId: string, page?: number, pageSize?: number): Promise<any> {
  return new NotificationEntitiesRepository(tenantId).findAllNotifications(page, pageSize);
}
export async function getNotificationById(tenantId: string, id: string): Promise<any> {
  return new NotificationEntitiesRepository(tenantId).findNotificationById(id);
}
export async function createNotification(tenantId: string, data: Record<string, unknown>): Promise<any> {
...
export async function listTemplates(tenantId: string, page?: number, pageSize?: number): Promise<any> {
...
export async function createTemplate(tenantId: string, data: Record<string, unknown>): Promise<any> {
...
export async function listChannels(tenantId: string, page?: number, pageSize?: number): Promise<any> {
  return new NotificationEntitiesRepository(tenantId).findAllChannels(page, pageSize);
}
export async function getChannelById(tenantId: string, id: string): Promise<any> {
  return new NotificationEntitiesRepository(tenantId).findChannelById(id);
}
export async function createChannel(tenantId: string, data: Record<string, unknown>): Promise<any> {
...
export async function listPreferences(tenantId: string, page?: number, pageSize?: number): Promise<any> {
  return new NotificationEntitiesRepository(tenantId).findAllPreferences(page, pageSize);
}
export async function getPreferenceById(tenantId: string, id: string): Promise<any> {
  return new NotificationEntitiesRepository(tenantId).findPreferenceById(id);
}
export async function createPreference(tenantId: string, data: Record<string, unknown>): Promise<any> {
...
export async function listRules(tenantId: string, page?: number, pageSize?: number): Promise<any> {
  return new NotificationEntitiesRepository(tenantId).findAllRules(page, pageSize);
}
export async function getRuleById(tenantId: string, id: string): Promise<any> {
  return new NotificationEntitiesRepository(tenantId).findRuleById(id);
}
export async function createRule(tenantId: string, data: Record<string, unknown>): Promise<any> {
...
export async function listBatches(tenantId: string, page?: number, pageSize?: number): Promise<any> {
  return new NotificationEntitiesRepository(tenantId).findAllBatches(page, pageSize);
}
export async function getBatchById(tenantId: string, id: string): Promise<any> {
  return new NotificationEntitiesRepository(tenantId).findBatchById(id);
}
export async function createBatch(tenantId: string, data: Record<string, unknown>): Promise<any> {
...
export async function listSubscriptions(tenantId: string, page?: number, pageSize?: number): Promise<any> {
  return new NotificationEntitiesRepository(tenantId).findAllSubscriptions(page, pageSize);
}
export async function getSubscriptionById(tenantId: string, id: string): Promise<any> {
  return new NotificationEntitiesRepository(tenantId).findSubscriptionById(id);
}
export async function createSubscription(tenantId: string, data: Record<string, unknown>): Promise<any> {
...
export async function listEmailTemplates(tenantId: string, page?: number, pageSize?: number): Promise<any> {
  return new NotificationEntitiesRepository(tenantId).findAllEmailTemplates(page, pageSize);
}
export async function getEmailTemplateById(tenantId: string, id: string): Promise<any> {
  return new NotificationEntitiesRepository(tenantId).findEmailTemplateById(id);
}
export async function createEmailTemplate(tenantId: string, data: Record<string, unknown>): Promise<any> {
...
export async function listMobilePushTokens(tenantId: string, page?: number, pageSize?: number): Promise<any> {
  return new NotificationEntitiesRepository(tenantId).findAllMobilePushTokens(page, pageSize);
}
export async function getMobilePushTokenById(tenantId: string, id: string): Promise<any> {
  return new NotificationEntitiesRepository(tenantId).findMobilePushTokenById(id);
}
export async function createMobilePushToken(tenantId: string, data: Record<string, unknown>): Promise<any> {
...
export async function listPushTokens(tenantId: string, page?: number, pageSize?: number): Promise<any> {
  return new NotificationEntitiesRepository(tenantId).findAllPushTokens(page, pageSize);
}
export async function getPushTokenById(tenantId: string, id: string): Promise<any> {
  return new NotificationEntitiesRepository(tenantId).findPushTokenById(id);
}
export async function createPushToken(tenantId: string, data: Record<string, unknown>): Promise<any> {
...
export async function listNotificationLog(tenantId: string, page?: number, pageSize?: number): Promise<any> {
  return new NotificationEntitiesRepository(tenantId).listNotificationLog(page, pageSize);
}
export async function createNotificationLog(tenantId: string, data: Record<string, unknown>): Promise<any> {
