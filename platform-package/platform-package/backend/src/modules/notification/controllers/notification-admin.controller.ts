...
import { ok, action } from '../../../errors/api-response';
import { setAuditData } from '../../../platform/dos/http/middleware/audit';
...
export async function updateModuleConfig(req: AuthenticatedRequest, res: Response): Promise<void> {
  setAuditData(res, { action: 'update', entityType: 'notification_config', entityId: 'notification' });
...
export async function reseedModule(req: AuthenticatedRequest, res: Response): Promise<void> {
  ...
  setAuditData(res, { action: 'reseed', entityType: 'notification', entityId: tenantId });
...
export async function reindexModule(req: AuthenticatedRequest, res: Response): Promise<void> {
  setAuditData(res, { action: 'reindex', entityType: 'notification', entityId: req.tenantId });
...
export async function backfillModule(req: AuthenticatedRequest, res: Response): Promise<void> {
  setAuditData(res, { action: 'backfill', entityType: 'notification', entityId: req.tenantId });
