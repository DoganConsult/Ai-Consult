...
-- Guard for fresh databases where migration 046 has not run yet
...
-- Ensure all canonical framework codes referenced by framework_alias exist
-- (prevents FK violations on fresh databases)
...
-- Ensure sector IDs referenced by sector_isic_map exist (legacy safety)
...
VALUES
  ...
  ('SEC-KSA-DEFENSE'),
  ('SEC-KSA-DIGITAL'),
  ('SEC-KSA-DIGITAL-HEALTH'),
  ('SEC-KSA-EDU-K12'),
  ('SEC-KSA-EDU-UNIV'),
  ('SEC-KSA-ENERGY-ELEC'),
  ('SEC-KSA-ENERGY-OG'),
  ('SEC-KSA-ENERGY-RENEW'),
  ('SEC-KSA-ENERGY-WATER'),
  ('SEC-KSA-FIN-BANK'),
  ('SEC-KSA-FIN-CAPITAL'),
  ('SEC-KSA-FIN-FINTECH'),
  ('SEC-KSA-FIN-INS'),
  ...
  ('SEC-KSA-HAJJ'),
  ('SEC-KSA-HEALTH-HOSP'),
  ('SEC-KSA-HEALTH-PHARMA'),
  ('SEC-KSA-HUMANITARIAN'),
  ('SEC-KSA-INDUSTRY'),
  ('SEC-KSA-LEGAL'),
  ('SEC-KSA-MEDIA'),
  ('SEC-KSA-MINING'),
  ('SEC-KSA-NONPROFIT'),
  ('SEC-KSA-NUCLEAR'),
  ('SEC-KSA-OPEN-BANKING'),
  ('SEC-KSA-PETROCHEM'),
  ('SEC-KSA-RETAIL'),
  ('SEC-KSA-SMARTCITY'),
  ('SEC-KSA-SPACE'),
  ('SEC-KSA-SPECIAL-ZONES'),
  ('SEC-KSA-SPORTS'),
  ('SEC-KSA-TEL-ICT'),
  ('SEC-KSA-TEL-OP'),
  ('SEC-KSA-TOURISM'),
...
LEFT JOIN public.sectors s ON s.sector_id = v.sector_id
