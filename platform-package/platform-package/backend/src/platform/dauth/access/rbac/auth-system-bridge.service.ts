...
export async function getUnifiedUserRoles(tenantId: string, userId: string): Promise<UnifiedRole[]> {
  ...
  try {
    ...
    for (const r of enterpriseRows as any[]) {
