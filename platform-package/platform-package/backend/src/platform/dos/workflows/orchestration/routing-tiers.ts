...
// TODO: Pending DOS foundation rebuild — team module removed
type ScopeType = 'tenant' | 'organization' | 'department' | 'team' | 'position' | 'process' | 'policy' | 'workflow';
async function resolveRACIAssignee(_tenantId: string, _scopeType: ScopeType, _scopeId: string, _raciRole: string): Promise<string | null> { return null; }
...
import { swallowNull, EC } from '../../../../platform/dos/resilience/resilient-catch';
