...
ALTER TABLE function_authorities ADD COLUMN IF NOT EXISTS priority INTEGER DEFAULT 100;
ALTER TABLE function_authorities ADD COLUMN IF NOT EXISTS max_risk_level VARCHAR(50);
ALTER TABLE function_authorities ADD COLUMN IF NOT EXISTS conditions JSONB DEFAULT '{}';
