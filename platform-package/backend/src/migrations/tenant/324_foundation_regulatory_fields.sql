...
DO $$ BEGIN
  ALTER TABLE sod_conflict_log ADD COLUMN IF NOT EXISTS status VARCHAR(20) NOT NULL DEFAULT 'open';
EXCEPTION WHEN OTHERS THEN NULL;
END $$;
DO $$ BEGIN
  ALTER TABLE sod_conflict_log ADD COLUMN IF NOT EXISTS conflict_type VARCHAR(30) NOT NULL DEFAULT 'role_pair';
EXCEPTION WHEN OTHERS THEN NULL;
END $$;
DO $$ BEGIN
  ALTER TABLE sod_conflict_log ADD COLUMN IF NOT EXISTS risk_level VARCHAR(20) NOT NULL DEFAULT 'high';
EXCEPTION WHEN OTHERS THEN NULL;
END $$;
DO $$ BEGIN
...
DO $$ BEGIN
  ALTER TABLE pdpl_consent_records ADD COLUMN IF NOT EXISTS consent_version VARCHAR(20) NOT NULL DEFAULT '1.0';
EXCEPTION WHEN OTHERS THEN NULL;
END $$;
DO $$ BEGIN
  ALTER TABLE pdpl_consent_records ADD COLUMN IF NOT EXISTS consent_type VARCHAR(50) NOT NULL DEFAULT 'general';
EXCEPTION WHEN OTHERS THEN NULL;
END $$;
DO $$ BEGIN
