...
CREATE INDEX IF NOT EXISTS idx_impact_incident ON incident_impacts (incident_id);
CREATE INDEX IF NOT EXISTS idx_impact_area ON incident_impacts (impact_area);
