...
DO $$ BEGIN ALTER TABLE risk_kris ADD COLUMN IF NOT EXISTS created_at TIMESTAMPTZ DEFAULT NOW(); EXCEPTION WHEN OTHERS THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE risk_kris ADD COLUMN IF NOT EXISTS updated_at TIMESTAMPTZ DEFAULT NOW(); EXCEPTION WHEN OTHERS THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE risk_kris ADD COLUMN IF NOT EXISTS deleted_at TIMESTAMPTZ; EXCEPTION WHEN OTHERS THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE risk_kris ADD COLUMN IF NOT EXISTS created_by VARCHAR(64); EXCEPTION WHEN OTHERS THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE risk_kris ADD COLUMN IF NOT EXISTS updated_by VARCHAR(64); EXCEPTION WHEN OTHERS THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE risk_kris ADD COLUMN IF NOT EXISTS deleted_by VARCHAR(64); EXCEPTION WHEN OTHERS THEN NULL; END $$;

CREATE INDEX IF NOT EXISTS idx_risk_kris_status ON risk_kris(status) WHERE deleted_at IS NULL;
CREATE INDEX IF NOT EXISTS idx_risk_kris_risk ON risk_kris(linked_risk_id) WHERE deleted_at IS NULL;
