...
CREATE INDEX idx_reg_sector_regulator ON regulator_sector_enforcement(regulator_id);
CREATE INDEX idx_reg_sector_sector ON regulator_sector_enforcement(sector_code);
...
CREATE INDEX idx_control_reg_control ON control_regulator_mapping(control_id);
CREATE INDEX idx_control_reg_regulator ON control_regulator_mapping(regulator_id);
CREATE INDEX idx_control_reg_sectors ON control_regulator_mapping USING GIN(applicable_sectors);
