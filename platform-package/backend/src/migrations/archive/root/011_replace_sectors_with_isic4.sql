...
INSERT INTO lookup_sectors (
    ...
    (gen_random_uuid(), 'A', 'Agriculture, forestry and fishing',
     ...
     'pi pi-tree', 1,
     ARRAY['nca_ecc']::TEXT[], ARRAY['NCA ECC']::TEXT[], true, 1, NOW()),
    ...
    (gen_random_uuid(), 'B', 'Mining and quarrying',
     ...
     'pi pi-compass', 1,
     ARRAY['nca_ecc', 'iso14001']::TEXT[], ARRAY['NCA ECC', 'ISO 14001']::TEXT[], true, 2, NOW()),
    ...
    (gen_random_uuid(), 'C', 'Manufacturing',
     ...
     'pi pi-cog', 1,
     ARRAY['nca_ecc', 'iso9001']::TEXT[], ARRAY['NCA ECC', 'ISO 9001']::TEXT[], true, 3, NOW()),
    ...
    (gen_random_uuid(), 'D', 'Electricity, gas, steam and air conditioning supply',
     ...
     'pi pi-bolt', 1,
     ARRAY['nca_ecc', 'nca_cscc', 'nca_otcc']::TEXT[], ARRAY['NCA ECC', 'NCA CSCC', 'NCA OTCC']::TEXT[], true, 4, NOW()),
    ...
    (gen_random_uuid(), 'E', 'Water supply; sewerage, waste management and remediation',
     ...
     'pi pi-filter', 1,
     ARRAY['nca_ecc', 'nca_cscc']::TEXT[], ARRAY['NCA ECC', 'NCA CSCC']::TEXT[], true, 5, NOW()),
    ...
    (gen_random_uuid(), 'F', 'Construction',
     ...
     'pi pi-building', 1,
     ARRAY['nca_ecc']::TEXT[], ARRAY['NCA ECC']::TEXT[], true, 6, NOW()),
    ...
    (gen_random_uuid(), 'G', 'Wholesale and retail trade; repair of motor vehicles',
     ...
     ARRAY['nca_ecc', 'pci_dss']::TEXT[], ARRAY['NCA ECC', 'PCI DSS']::TEXT[], true, 7, NOW()),
    ...
    (gen_random_uuid(), 'H', 'Transportation and storage',
     ...
     'pi pi-truck', 1,
     ARRAY['nca_ecc']::TEXT[], ARRAY['NCA ECC']::TEXT[], true, 8, NOW()),
    ...
    (gen_random_uuid(), 'I', 'Accommodation and food service activities',
     ...
     'pi pi-home', 1,
     ARRAY['nca_ecc']::TEXT[], ARRAY['NCA ECC']::TEXT[], true, 9, NOW()),
    ...
    (gen_random_uuid(), 'J', 'Information and communication',
     ...
     'pi pi-globe', 1,
     ARRAY['nca_ecc', 'nca_tcc', 'iso27001']::TEXT[], ARRAY['NCA ECC', 'NCA TCC', 'ISO 27001']::TEXT[], true, 10, NOW()),
    ...
    (gen_random_uuid(), 'K', 'Financial and insurance activities',
     ...
     'pi pi-dollar', 1,
     ARRAY['sama_csf', 'nca_ecc', 'pci_dss']::TEXT[], ARRAY['SAMA CSF', 'NCA ECC', 'PCI DSS']::TEXT[], true, 11, NOW()),
    ...
    (gen_random_uuid(), 'L', 'Real estate activities',
     ...
     'pi pi-map', 1,
     ARRAY['nca_ecc']::TEXT[], ARRAY['NCA ECC']::TEXT[], true, 12, NOW()),
    ...
    (gen_random_uuid(), 'M', 'Professional, scientific and technical activities',
     ...
     'pi pi-briefcase', 1,
     ARRAY['nca_ecc', 'iso27001']::TEXT[], ARRAY['NCA ECC', 'ISO 27001']::TEXT[], true, 13, NOW()),
    ...
    (gen_random_uuid(), 'N', 'Administrative and support service activities',
     ...
     'pi pi-users', 1,
     ARRAY['nca_ecc']::TEXT[], ARRAY['NCA ECC']::TEXT[], true, 14, NOW()),
    ...
    (gen_random_uuid(), 'O', 'Public administration and defence; compulsory social security',
     ...
     'pi pi-shield', 1,
     ARRAY['nca_ecc', 'nca_cscc']::TEXT[], ARRAY['NCA ECC', 'NCA CSCC']::TEXT[], true, 15, NOW()),
    ...
    (gen_random_uuid(), 'P', 'Education',
     ...
     'pi pi-book', 1,
     ARRAY['nca_ecc']::TEXT[], ARRAY['NCA ECC']::TEXT[], true, 16, NOW()),
    ...
    (gen_random_uuid(), 'Q', 'Human health and social work activities',
     ...
     'pi pi-heart', 1,
     ARRAY['nca_ecc', 'hipaa']::TEXT[], ARRAY['NCA ECC', 'HIPAA']::TEXT[], true, 17, NOW()),
    ...
    (gen_random_uuid(), 'R', 'Arts, entertainment and recreation',
     ...
     'pi pi-palette', 1,
     ARRAY['nca_ecc']::TEXT[], ARRAY['NCA ECC']::TEXT[], true, 18, NOW()),
    ...
    (gen_random_uuid(), 'S', 'Other service activities',
     ...
     'pi pi-wrench', 1,
     ARRAY['nca_ecc']::TEXT[], ARRAY['NCA ECC']::TEXT[], true, 19, NOW()),
    ...
    (gen_random_uuid(), 'T', 'Activities of households as employers',
     ...
     'pi pi-home', 1,
     ARRAY[]::TEXT[], ARRAY[]::TEXT[], true, 20, NOW()),
    ...
    (gen_random_uuid(), 'U', 'Activities of extraterritorial organizations',
     ...
     'pi pi-flag', 1,
     ARRAY[]::TEXT[], ARRAY[]::TEXT[], true, 21, NOW());

-- Step 4: Update any references in other tables
-- Update company_profiles to use ISIC4 codes
