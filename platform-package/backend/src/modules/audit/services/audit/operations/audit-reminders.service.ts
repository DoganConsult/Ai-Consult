...
export async function getUpcomingDeadlines(tenantId: string, daysAhead: number = 7): Promise<any> {
...
export async function generateReminders(tenantId: string): Promise<any> {
  const s = tenantSchema(tenantId);
