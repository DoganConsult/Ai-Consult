...
import { completeProcessTask } from '../../../../platform/dos/workflows/orchestration/task-completion';
import { eventBus, type PlatformEvent } from '../../../platform/services/event/event-bus.service';
...
interface AutoResolutionRule {
  ...
  resolution_conditions: Record<string, any>;
  auto_close: boolean;
