...
// ============================================
// Shahin GRC — Regulatory Clause & Obligation Extraction
...
import { getDocumentElements, ParsedElement } from "../../../platform/services/document/document-parser.service";
...
function extractEntities(text: string): string[] {
  ...
  const __lower = text.toLowerCase();
      ...
      payload: {
        ...
        clauseTypes: Object.fromEntries(
          (["obligation", "prohibition", "permission", "exception", "definition", "scope", "penalty", "reporting", "timeline"] as ClauseType[]).map(
            (t) => [t, clauses.filter((c) => c.clauseType === t).length],
          ),
        ),
      },
    });
