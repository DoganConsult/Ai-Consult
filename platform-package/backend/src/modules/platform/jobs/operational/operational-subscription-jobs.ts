...
/**
 * Subscription domain operational job definitions.
 * Covers trial lifecycle, subscription reminders, grace expiry,
 * usage snapshots, and scheduled changes (downgrades).
 */
...
export async function getSubscriptionOperationalJobs(): Promise<JobDefinition[]> {
  return [
