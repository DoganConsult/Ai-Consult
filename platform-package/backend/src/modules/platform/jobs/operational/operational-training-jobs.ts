// @ts-nocheck
/**
 * Training domain operational job definitions.
 * Covers overdue assignment checks, expiring certifications,
...
export async function getTrainingOperationalJobs(): Promise<JobDefinition[]> {
