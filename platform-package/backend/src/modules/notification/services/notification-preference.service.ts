...
function mapPref(r: any): NotificationPreference {
  return {
    ...
    frequencyLimit: r.frequency_limit ? parseInt(r.frequency_limit, 10) : null,
    frequencyWindowHours: r.frequency_window_hours ? parseInt(r.frequency_window_hours, 10) : null,
    createdAt: r.created_at?.toISOString?.() || r.created_at,
    updatedAt: r.updated_at?.toISOString?.() || r.updated_at,
  };
}

function mapQuietHours(r: any): QuietHours {
  return {
