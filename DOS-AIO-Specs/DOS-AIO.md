...
> **25,500+ lines · 16 platform patches (0–15) + 44 module patches (MP-01–MP-44) · Single source of truth for DOS / DAuth / Shahin-AI**
>
...
> Extended module library (MP-01–MP-44): See [`DOS-AIO-Specs/`](DOS-AIO-Specs/README.md)
> Operational registry: [`DOS-AIO-actualcodebase.csv`](DOS-AIO-actualcodebase.csv) — 202 columns × 65 modules
...
| **Module Patch Library** | 44 | [`DOS-AIO-Specs/`](DOS-AIO-Specs/) | End-to-end module patches MP-01–MP-44. Canonical per-module specs. |
...
> Cross-references: DOS-AIO.md inline specs (MP-01–MP-16) + `DOS-AIO-Specs/module-patch-*.md` external specs (MP-01–MP-44).
...
| `covered_in_external_module_patch_library` | 27 | 273,490 | Spec in `DOS-AIO-Specs/module-patch-*.md` |
| `platform_or_dauth_surface_not_a_product_module` | 3 | 10,810 | DOS/DAuth concern — not a product module |
| `orphan_or_alias_needing_new_spec` | 13 | 13,187 | No governing spec — needs new module patch |
| **Total** | **65** | **717,360** | |
...
| MP-45 Attestation | `attestation` | (no spec) | ❌ orphan | cross_module_surface | 403 |
| MP-08 Audit | `audit` | MP-08 | ✅ inline | canonical_spec_module | 21,312 |
| MP-22 BCP | `bcp` | MP-22 | ✅ external | canonical_spec_module | 8,487 |
| MP-46 Benchmarks | `benchmarks` | (no spec) | ❌ orphan | cross_module_surface | 505 |
...
| MP-47 Dashboard Editor | `dashboard-editor` | (no spec) | ❌ orphan | technical_support_surface | 338 |
...
| MP-48 Executive | `executive` | (no spec) | ❌ orphan | technical_support_surface | 115 |
| MP-49 Fitch | `fitch` | (no spec) | ❌ orphan | technical_support_surface | 791 |
...
| MP-53 GRC Query | `grc-query` | (no spec) | ❌ orphan | cross_module_surface | 254 |
...
| MP-54 Knowledge | `knowledge` | (no spec) | ❌ orphan | cross_module_surface | 1,704 |
...
| MP-55 MCP | `mcp` | (no spec) | ❌ orphan | technical_support_surface | 172 |
| MP-56 Mobile | `mobile` | (no spec) | ❌ orphan | technical_support_surface | 4,404 |
...
| MP-59 Operating Cockpit | `operating-cockpit` | (no spec) | ❌ orphan | technical_support_surface | 220 |
| MP-36 Packs | `packs` | MP-36 | ✅ external | canonical_spec_module | 7,679 |
| MP-60 Platform Stats | `platform-stats` | (no spec) | ❌ orphan | technical_support_surface | 409 |
| MP-61 Playbooks | `playbooks` | (no spec) | ❌ orphan | product_bundle_or_hub | 233 |
...
| MP-65 Team | `team` | (no spec) | ❌ orphan | canonical_spec_module | 3,639 |
...
#### Orphan Surfaces (no governing spec)

| Module | LOC | Class | Action |
|--------|-----|-------|--------|
| `mobile` | 4,404 | technical_support_surface | New module patch needed |
| `team` | 3,639 | canonical_spec_module | New module patch needed |
| `knowledge` | 1,704 | cross_module_surface | New module patch needed |
| `fitch` | 791 | technical_support_surface | New module patch needed |
| `benchmarks` | 505 | cross_module_surface | New module patch needed |
| `platform-stats` | 409 | technical_support_surface | New module patch needed |
| `attestation` | 403 | cross_module_surface | New module patch needed |
| `dashboard-editor` | 338 | technical_support_surface | New module patch needed |
| `grc-query` | 254 | cross_module_surface | New module patch needed |
| `playbooks` | 233 | product_bundle_or_hub | New module patch needed |
| `operating-cockpit` | 220 | technical_support_surface | New module patch needed |
| `mcp` | 172 | technical_support_surface | New module patch needed |
| `executive` | 115 | technical_support_surface | New module patch needed |
...
| Law 10 — Migration modes expire | **FIXED** | V2 death dates in §5D; v2 table renames Phase 9 (§22 #14) |
