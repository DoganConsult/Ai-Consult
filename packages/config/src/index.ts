...
export const KernelConfigSchema = Type.Object({
  ...
  TEMPORAL_TASK_QUEUE_DEFAULT: Type.String({ default: 'dogan-default' }),
  TEMPORAL_API_KEY: Type.Optional(Type.String()),
  AGENTS_DEFAULT_MODEL: Type.String({ default: 'gpt-4o-mini' }),
  LANGSMITH_API_KEY: Type.Optional(Type.String()),
  LANGSMITH_PROJECT: Type.String({ default: 'dogan-ai-os' }),
  LANGSMITH_ENDPOINT: Type.Optional(Type.String()),
